// run-demo-simple.js - GraphAIデモ実行スクリプト（シンプル版）
...
async function runImageProcessingDemo() {
  ...
  try {
    ...
    console.log('🔧 エージェント登録状況:');
    console.log(`- カスタムエージェント: imageProcessingAgent`);
    console.log(`- エージェント構造:`, imageProcessingAgent);
    ...
    // デバッグ情報
    console.log('\n🔍 デバッグ情報:');
    console.log('imageProcessingAgent:', typeof imageProcessingAgent);
    console.log('imageProcessingAgent keys:', Object.keys(imageProcessingAgent || {}));
  }
}
        ...
        <div class="container">
          ...
          <div class="pipeline">
            ...
            <div class="images">
              ...
              <div class="image-stage">
                <h4>Mosaic</h4>
                <img src="/output/image2_mosaic.jpg" alt="モザイク2">
              </div>
              <span class="arrow">→</span>
              <div class="image-stage">
                <h4>Rotated</h4>
                <img src="/output/image2_rotated.jpg" alt="回転2">
              </div>
              <span class="arrow">→</span>
              <div class="image-stage">
                <h4>Final</h4>
                <img src="/output/image2_final.jpg" alt="最終2">
              </div>
            </div>
          </div>
          ...
          <div class="pipeline">
            ...
            <div class="images">
              ...
              <div class="image-stage">
                <h4>Mosaic</h4>
                <img src="/output/image3_mosaic.jpg" alt="モザイク3">
              </div>
              <span class="arrow">→</span>
              <div class="image-stage">
                <h4>Rotated</h4>
                <img src="/output/image3_rotated.jpg" alt="回転3">
              </div>
              <span class="arrow">→</span>
              <div class="image-stage">
                <h4>Final</h4>
                <img src="/output/image3_final.jpg" alt="最終3">
              </div>
            </div>
          </div>
